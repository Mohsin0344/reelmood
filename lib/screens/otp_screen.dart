    ...
    return Scaffold(
              ...
              child: Container(
                ...
                child: PinPut(
                  ...
                  onSubmit: (String pin) async{
                    ...
                    if(userData!= null){
                      await userSignUp(widget.email, widget.password,
                          widget.fullName);
                    }
                  },
        ...
        bottomNavigationBar: Visibility(
          ...
          child: Padding(
            ...
            child: customButton('Create Account', () async{
              setState(() {
                isLoading = true;
              });
              var userData = await auth.signInWithCredential(
        ...
        verificationCompleted: (PhoneAuthCredential credential) async{
          auth.signInWithCredential(credential).then((value) async{
            if(value.user != null){
              print('logged in');
              if(dataLoaded == true){
                print('im in signup XxXXXXXXXXXXXXXXXX');
                await userSignUp(widget.email, widget.password, widget.fullName);
              }
            }
          });
        },
